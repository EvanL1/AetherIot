"""Binding-driven composition helpers for PV forecasting processors."""
...
BACKEND_BINDINGS_ENV = "AETHER_PV_FORECASTING_BACKEND_BINDINGS"
    ...
    *,
    ...
    if legacy_inference_service is not None:
        registry.register_factory(
            ...
            description="PV legacy Edge-Platform backend",
...
def create_processor_from_bindings(
    *,
    ...
    return PvForecastProcessor(engine=backend, policy=active_policy)
